    ...
    <section id='about' className='px-auto mt-44'>
      <div className='flex flex-col md:flex-row gap-14 md:gap-18 max-w-7xl mx-auto'>
        ...
        <div>
          ...
          <Animated delay={0.2}>
            <p className='mt-4.5 text-zinc-600 max-w-sm'>We combine fresh local ingredients, creative recipies and elegant presentation to deliver a memorable expreience with every visit.</p>
          </Animated>

          <Animated className="mt-9 bg-orange-500 text-white p-2 pr-8 rounded-lg flex items-center gap-3 w-fit">
            <img src='/assets/about.png' alt='Bistro Royal Location Preview' className='size-15 rounded-lg-boject-cover shrink-0' />
