            ...
            <div className='text-center mb-16 '>
                ...
                <Animated delay={0.2}>
                    <h2 className='text-4xl md:text-5xl max-w-lg mx-auto text-balance'>
                        Crafting memorable dining experirnce
                    </h2>
                </Animated>
            </div>

            <div className="flex flex-col md:flex-row items-center justify-between gap-14 max-w-7xl max-auto">
                <div className="space-y-10 max-w-md">
                    {featuresData.map((item, index) => {
                        const IconComponent = icomMap[item.icon];
                        return (
                ...
                <Animated x={50} y={0}>
                    <img src="/assets/chef.png" alt="chef" className="w-full max-w-md h-111 object-cover rounded-3xl" />
                </Animated>
            </div>
